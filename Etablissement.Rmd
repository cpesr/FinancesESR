...
fin.all  %>%
  ...
  ggplot(aes(x=exercice,y=Valeur,color=etablissement)) +
    geom_col(aes(y=Différence.annuelle,fill=etablissement), position="dodge", color=NA, alpha=0.5) +
    geom_point(size=2) + geom_line(aes(group=etablissement)) +
    scale_color_brewer(palette="Purples", name="Valeur absolue") +
    scale_fill_brewer(palette="Purples", name="Différence annuelle") +
